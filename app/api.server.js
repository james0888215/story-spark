...
export async function submitPrompt(word = "") {
  ...
  function generatePrompt(word) {
    return `Tell me a short 1 minute kids story with a girl named ${word}. ${word} is a girl and the story should be child friendly and have a happy ending. The story should not describe what ${word} looks like.
